...
import {
    ...
    editUserClose,
    filterUsers
} from '../../../actions/adminPanel/actions/actionsUsersPanel';

// Components
import UserItemContainer from '../UserItem/UserItem';
import ListOfPages from '../../../components/AdminPanel/ListOfPagesUsers/ListOfPages';
import FilterUsers from '../FilterUsers/FilterUsers';
import AddingUserContainer from '../AddingUser/AddingUser';
import EditUser from '../EditFormUser/EditFormUser';
                    ...
                    <Col className='col-9'>
                        <CardColumns>
                            {(usersToShow) && usersToShow.map(el => (
                                <UserItemContainer key={`el${el.username}${el.id}`} obj={el} openPage={this.openPage} />
                            ))}
                        </CardColumns>
                    </Col>
                </Row>
