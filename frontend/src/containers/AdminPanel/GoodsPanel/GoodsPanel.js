...
import GoodsItemContainer from '../GoodsItem/GoodsItem';
import ListOfPagesComponent from '../../../components/AdminPanel/ListOfPagesGoods/ListOfPages';
import FilterGoodsPanelComponent from '../../../components/AdminPanel/FilterGoodsPanel/FilterGoodsPanel';
import AddingGoodContainer from '../AddingGood/AddingGood';
import EditGoodsItemContainer from '../EditGoodsItem/EditGoodsItem';
import DeleteFormContainer from '../DeleteFormGoods/DeleteFormGoods';
...
} from '../../../actions/adminPanel/actions/actionsGoodsPanel';
                        ...
                        <Col xs={8} className='d-flex flex-column justify-content-between'>
                            {
                                goodsToShow && goodsToShow.map(el => (
                                    <GoodsItemContainer key={`GoodsInAdminPanel ${el.idgoods}`} obj={el} />
                                ))
                            }
