...
CREATE TABLE IF NOT EXISTS `goods_has_imgs` (
  `goods_idgoods` INT NULL,
  `goods_catalogue_id_catalogue` INT NULL,
  `imgs_id_img` INT NULL,
  `id` INT NOT NULL AUTO_INCREMENT,
  `title` TINYINT NULL DEFAULT 0,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Data for table `goods_has_imgs`
-- -----------------------------------------------------
START TRANSACTION;
USE `store_project`;
INSERT INTO `goods_has_imgs` (`goods_idgoods`, `goods_catalogue_id_catalogue`, `imgs_id_img`, `id`, `title`) VALUES (1, 4, 3, 1, 1);
INSERT INTO `goods_has_imgs` (`goods_idgoods`, `goods_catalogue_id_catalogue`, `imgs_id_img`, `id`, `title`) VALUES (1, 4, 2, 2, 1);
